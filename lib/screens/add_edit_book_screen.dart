...
class _AddEditBookScreenState extends State<AddEditBookScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(isEditMode ? '编辑图书' : '添加新书')),
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          isEditMode ? '修改后的信息将立即同步到所有设备' : '新添加的图书将立即在图书列表中显示',
                          style: TextStyle(
                            fontSize: 12,
                            color: Colors.blue[700],
                          ),
    ...
    if (_existingImageUrl != null && _existingImageUrl!.isNotEmpty) {
      return ClipRRect(
        ...
        child: Stack(
          ...
          children: [
            Image.network(
              BackendConfig.resolveFileUrl(_existingImageUrl!),
              fit: BoxFit.cover,
  ...
  Widget _buildPlaceholder() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text('添加封面图片', style: TextStyle(color: Colors.grey[600], fontSize: 14)),
      ],
    );
  }
}
